...
/*
open saucedemo.com is common for all the test ==> is in the starting ==> pre condition
close the browser is common for all the test ==> ion the ending ==> post condition
